...
const navigation = ["Overview", "Agent Catalog", "Workflow Console", "Approvals", "Evaluations", "Release Gates", "Observability", "Identity & Access", "Deployments", "Audit Explorer"];
const navigationLinks: Record<string, string> = { "Overview": "/", "Agent Catalog": "/agent-catalog", "Workflow Console": "/workflow", "Approvals": "/approvals", "Evaluations": "/evaluations", "Release Gates": "/release-evaluations", "Observability": "/observability", "Identity & Access": "/identity", "Deployments": "#planned", "Audit Explorer": "/audit" };
